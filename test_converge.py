...
def test(final_mc_file, filelist, k):
    ...
    for myfile in filelist:
        ...
        res = perm_rank(testG, gold_dict, 10000) ;
        print myfile ;
        print res ;
...
if __name__ == "__main__":
    ...
    final_mc_file = "res_1000000.txt" ; 
    #filelist=['res_100.txt', 'res_500.txt', 'res_1000.txt', 'res_5000.txt', 'res_10000.txt', 'res_100000.txt'] ;
    filelist=['res_100.txt', 'res_1000.txt', 'res_10000.txt', 'res_100000.txt', 'res_1000000.txt'] ;
    main_path = "converge_file_better" ;
